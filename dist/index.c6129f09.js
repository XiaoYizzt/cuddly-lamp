...
})({"cU5TP":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "52df9318c6129f09";
"use strict";
...
(0, _gsap.gsap).set(contentOverlayInner, {
    xPercent: -100
});
// Preview Items
const previewItems = [];
    ...
    contentItem.DOM.imgWrap.addEventListener("click", ()=>{
        ...
        (0, _gsap.gsap).timeline({
            ...
            onStart: ()=>{
                ...
                (0, _gsap.gsap).set(previewItem.DOM.imgWrap, {
                    xPercent: -102,
                    opacity: 0
                });
        ...
        }).addLabel("start", 0).addLabel("preview", "start+=0.3").to(contentOverlayInner, {
            ease: "power2",
            startAt: {
                xPercent: -100
            },
            ...
            previewItem.DOM.img,
            previewItem.DOM.imgWrap
        ], {
            xPercent: 0
        }, "preview").to(previewItem.DOM.imgWrap, {
            opacity: 1
        }, "preview").to(previewItem.DOM.slideTexts, {
            yPercent: 0,
            stagger: 0.05
        }, "preview").to(previewItem.DOM.descriptions, {
            ease: "power2",
            opacity: 1,
            stagger: 0.05
        }, "preview").to(previewItem.DOM.descriptions, {
...
backCtrl.addEventListener("click", ()=>{
    ...
    (0, _gsap.gsap).timeline({
        ...
        xPercent: -100
    }, "start").to(previewItem.DOM.imgWrap, {
        xPercent: 100,
        opacity: 1
    }, "start").to(contentOverlayInner, {
        ease: "power2",
        xPercent: 100
    }, "start+=0.4");
});
...
},{"gsap":"3LPLT","./utils":"eYK4L","./contentItem":"7VNk8","./previewItem":"94Cef"}]},["cU5TP","1Z4Rq"], "1Z4Rq", "parcelRequire94c2")

//# sourceMappingURL=index.c6129f09.js.map
