...
})({"8RM9L":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c4abf0cd3d0fe026";
"use strict";
...
},{}],"ccOYv":[function(require,module,exports) {
    ...
    contentItem.DOM.imgWrap.addEventListener("click", ()=>{
        ...
        (0, _gsap.gsap).timeline({
            ...
            onStart: ()=>{
                ...
                (0, _gsap.gsap).set(previewItem.DOM.el, {
                    clipPath: `circle(0vmax at ${winsize.width / 2}px ${winsize.height / 2}px)`
                });
                (0, _gsap.gsap).set(previewItem.DOM.img, {
                    scale: 0.8
                });
                (0, _gsap.gsap).set(previewItem.DOM.title, {
                    scale: 1.6
                });
                (0, _gsap.gsap).set(previewItem.DOM.boxes, {
        ...
        }).addLabel("start", 0).addLabel("preview", "start+=0.3").to(contentItem.DOM.imgWrap, {
            ease: "power2",
            scale: 1.2
        }, "start").to(contentOverlay, {
            ease: "power2",
            scale: 1
        }, "start").to(previewItem.DOM.el, {
            duration: 0.9,
            ease: "power2",
            clipPath: `circle(60vmax at ${winsize.width / 2}px ${winsize.height / 2}px)`
        }, "preview").to([
            previewItem.DOM.img,
            previewItem.DOM.title
        ], {
            scale: 1
        }, "preview").to(previewItem.DOM.boxes, {
            xPercent: 0
        }, "preview").to(backCtrl, {
            ease: "power2",
            opacity: 1,
...
backCtrl.addEventListener("click", ()=>{
    ...
    (0, _gsap.gsap).timeline({
    ...
    }).addLabel("start", 0).addLabel("content", "start+=0.2").to(backCtrl, {
        opacity: 0
    }, "start").to(previewItem.DOM.title, {
        scale: 0.6
    }, "start").to(previewItem.DOM.img, {
        scale: 0.9
    }, "start").to(previewItem.DOM.el, {
        duration: 0.6,
        clipPath: `circle(0vmax at ${winsize.width / 2}px ${winsize.height / 2}px)`
        ...
        ease: "power3.inOut",
        scale: 0
    }, "content").to(contentItems[current].DOM.imgWrap, {
        startAt: {
            scale: 1.2
        },
        scale: 1
...
},{"gsap":"3LPLT","./utils":"eYK4L","./contentItem":"7VNk8","./previewItem":"94Cef"}]},["8RM9L","ccOYv"], "ccOYv", "parcelRequire94c2")

//# sourceMappingURL=index2.3d0fe026.js.map
